        ...
        <!-- This code is taken from http://twitter.github.com/bootstrap/examples/hero.html -->
            ...
            <div class="container bg-white">
                ...
                <div class="row-fluid">
                    ...
                    <td><strong><font color="black">Gender</font></strong></td>
                    ...
                    <td><strong><font color="black">Leave Count</font></strong></td>
                    <td><strong><font color="black">Generate_Salary</font></strong></td>
                    </tr>
                    ...
                    while(rs.next())
                    {
                    	...
                    	PreparedStatement ps1 = con.prepareStatement("select sum(count) from leasverequest where useremail='"+email+"'");
                    	ResultSet rs1 =ps1.executeQuery();
                    	while(rs1.next())
                    	{
                    		String salarycount = rs1.getString(1);	
                    		
                    		%>
                    		<%-- <tr>
                    		<td><input type="text" value="<%=fname%>" disabled="disabled"></td>
                    		<td><input type="text" value="<%=lname%>" disabled="disabled"></td>
                    		<td><input type="text" value="<%=gender%>" disabled="disabled"></td>
                    		<td><input type="text" value="<%=email%>" disabled="disabled"></td>
                    		<td><input type="text" value="<%=mobile%>" disabled="disabled"></td>
                    		<td><input type="text" value="<%=designation%>" disabled="disabled"></td>
                    		<td><input type="text" value="<%=salery%>" disabled="disabled"></td>
                    		<td><input type="text" value="<%=salarycount%>" disabled="disabled"></td>
                    		
                    		</tr> --%>
                    		<tr>
                    		<td width="100px"><%=fname%></td>
                    		<td width="100px"><%=lname%></td>
                    		<td width="100px"><%=gender%></td>
                    		<td width="100px"><%=email%></td>
                    		<td width="100px"><%=mobile%></td>
                    		<td width="100px"><%=designation%></td>
                    		<td width="100px"><%=salery%></td>
                    		<td width="100px"><%=salarycount%></td>
                    		<td><a href="calculatesalary.jsp?email=<%=email%>&salary=<%=salery%>&count=<%=salarycount%>">salary</a></td>
