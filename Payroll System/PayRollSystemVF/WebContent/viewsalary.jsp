        ...
        <!-- This code is taken from http://twitter.github.com/bootstrap/examples/hero.html -->
            ...
            <div class="container bg-white">
                ...
                <div class="row-fluid">
                    ...
                    <table border="1">
                    <tr>
                    <td><strong>Leave Count</strong></td>
                    <td><strong>Deduction</strong></td>
                     <td><strong>Final Salery</strong></td>
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT * FROM `empsalery` WHERE empemail='"+email+"'");
                    ResultSet rs = ps.executeQuery();
                    while(rs.next())
                    {
                    	%>
                    		<tr>
                    		<td><input type="text" value="<%=rs.getString("leavecount") %>" disabled="disabled"> </td>
                    		<td><input type="text" value="<%=rs.getString("deduction") %>" disabled="disabled"> </td>
                    		<td><input type="text" value="<%=rs.getString("finalsalary") %>" disabled="disabled"> </td>
                    		</tr>
                    	<%
                    }
