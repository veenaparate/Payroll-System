        ...
        <!-- This code is taken from http://twitter.github.com/bootstrap/examples/hero.html -->
            ...
            <div class="container bg-white">
                ...
                <div class="row-fluid">
                    ...
                    String leavecount = request.getParameter("count");
                    String deduction = request.getParameter("deduct");
                    String finalsalery = request.getParameter("finalsalery");
                    System.out.println("Email=ssssss=="+email);
                    System.out.println("final salery=ssssss=="+finalsalery);
